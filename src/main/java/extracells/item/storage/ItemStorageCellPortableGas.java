 ...
 *
 */
public class ItemStorageCellPortableGas extends PowerItem implements IPortableGasStorageCell {
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStack, World world, EntityPlayer player, EnumHand hand) {
		return new ActionResult<ItemStack>(EnumActionResult.SUCCESS, ECApi.instance().openPortableGasCellGui(player, hand, world));
	}
