...
public class GasUtil {
	...
	public static IAEFluidStack createAEFluidStack(Gas gas) {
		return null;
		//return createAEFluidStack(new FluidStack(MekanismGas.getFluidGasMap().get(gas),FluidContainerRegistry.BUCKET_VOLUME));
	}

	public static IAEFluidStack createAEFluidStack(GasStack gasStack) {
		return null;//return gasStack == null ? null : createAEFluidStack(new FluidStack(MekanismGas.getFluidGasMap().get(gasStack.getGas()), gasStack.amount));
	}
	...
	public static IAEFluidStack createAEFluidStack(Gas gas, long amount) {
		return null;//return createAEFluidStack(new FluidStack(MekanismGas.getFluidGasMap().get(gas), 1)).setStackSize(amount);
	}
	...
	public static boolean isGas(Fluid fluid) {
		return false;//return fluid != null && fluid instanceof MekanismGas.GasFluid;
	}
